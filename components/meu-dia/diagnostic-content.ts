...
export const diagnosticHero = {
  ...
  description:
    "Uma entrada guiada para organizar contexto pessoal, mapear eixos críticos e produzir uma leitura acionável que conversa com metas, relatórios e o restante do ciclo Meu Dia.",
} as const
